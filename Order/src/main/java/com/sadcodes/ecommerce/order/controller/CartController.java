...
import com.sadcodes.ecommerce.order.services.CartService;
...
public class CartController {
    ...
    public ResponseEntity<Void> removeCart(@RequestHeader("X-USER-ID") String userId, @PathVariable String productId) {
